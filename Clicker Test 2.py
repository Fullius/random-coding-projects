...
GEN3 = pygame.draw.rect(DRAW_SCREEN, BUTTON_COLOR, pygame.Rect(0, 165, 200, 30), 1)
...
def handle_mouse_clicks():
	global CASH, PROFITS, GEN1_TIMER, GEN2_TIMER, GEN3_TIMER, GEN1_LEVEL, GEN2_LEVEL, GEN3_LEVEL
...
def update_text():
	global CASH_LABEL, GEN1_LEVEL_LABEL, GEN2_LEVEL_LABEL, GEN3_LEVEL_LABEL
	...
	GEN3_LEVEL_LABEL = FONT.render('Level: {}/{} --- $1000/{} milliseconds'.format(GEN3_LEVEL, 100, GEN3_TIME), 1, (255,255,0))
	WINDOW.blit(GEN3_LEVEL_LABEL, (220, 243))
	pygame.display.flip()
